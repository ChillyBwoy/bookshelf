...
var author$project$Main$BookAddMsg = function (a) {
	return {$: 'BookAddMsg', a: a};
};
var author$project$Main$PageBookAdd = function (a) {
	return {$: 'PageBookAdd', a: a};
};
...
var author$project$Main$loadBookAddPage = F2(
	function (model, _n0) {
		var m = _n0.a;
		var cmds = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$PageBookAdd(m)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$BookAddMsg, cmds));
	});
...
var author$project$Main$loadBookDetailPage = F2(
	function (model, _n0) {
		var book = _n0.a;
		var cmds = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$PageBookDetail(book)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$BookDetailMsg, cmds));
	});
var author$project$Main$BookListMsg = function (a) {
	return {$: 'BookListMsg', a: a};
};
var author$project$Main$PageBookList = function (a) {
	return {$: 'PageBookList', a: a};
};
var author$project$Main$loadBookListPage = F2(
	function (model, _n0) {
		var bookList = _n0.a;
		var cmds = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$PageBookList(bookList)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$BookListMsg, cmds));
	});
...
var author$project$Main$loadPageHome = F2(
	function (model, _n0) {
		var m = _n0.a;
		var cmds = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$PageHome(m)
				}),
			A2(elm$core$Platform$Cmd$map, author$project$Main$HomeMsg, cmds));
	});
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Page$Book$Add$init = function (flags) {
	return _Utils_Tuple2(
		{},
		elm$core$Platform$Cmd$none);
};
var author$project$Model$Book = F5(
	function (id, description, isbn, title, publishedAt) {
		return {description: description, id: id, isbn: isbn, publishedAt: publishedAt, title: title};
	});
...
var justinmimbs$date$Date$fromIsoString = A2(
	...
	elm$core$Result$mapError(
		A2(
			...
			elm$core$String$join('; '))));
var author$project$Shared$decodeDate = A2(
	elm$json$Json$Decode$andThen,
	function (str) {
		var _n0 = justinmimbs$date$Date$fromIsoString(str);
		if (_n0.$ === 'Err') {
			var err = _n0.a;
...
var author$project$Model$decodeBook = A6(
	elm$json$Json$Decode$map5,
	author$project$Model$Book,
	A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'description', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'isbn', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'title', elm$json$Json$Decode$string),
	elm$json$Json$Decode$maybe(
		A2(elm$json$Json$Decode$field, 'publishedAt', author$project$Shared$decodeDate)));
var author$project$Page$Book$Detail$OnFetch = function (a) {
	return {$: 'OnFetch', a: a};
};
...
var author$project$Page$Book$Detail$fetch = F2(
	function (flags, id) {
		return elm$http$Http$get(
			{
				expect: A2(elm$http$Http$expectJson, author$project$Page$Book$Detail$OnFetch, author$project$Model$decodeBook),
				url: flags.api + ('/books/' + elm$core$String$fromInt(id))
			});
	});
var author$project$Shared$Loading = {$: 'Loading'};
var author$project$Page$Book$Detail$init = F2(
	function (flags, id) {
		return _Utils_Tuple2(
			{book: author$project$Shared$Loading, id: id},
			A2(author$project$Page$Book$Detail$fetch, flags, id));
	});
var author$project$Page$Book$List$OnFetchBooks = function (a) {
	return {$: 'OnFetchBooks', a: a};
};
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Page$Book$List$fetchBooks = function (flags) {
	return elm$http$Http$get(
		{
			expect: A2(
				elm$http$Http$expectJson,
				author$project$Page$Book$List$OnFetchBooks,
				elm$json$Json$Decode$list(author$project$Model$decodeBook)),
			url: flags.api + '/books'
		});
};
var author$project$Page$Book$List$init = function (flags) {
	return _Utils_Tuple2(
		{books: author$project$Shared$Loading},
		author$project$Page$Book$List$fetchBooks(flags));
};
var author$project$Page$Home$init = function (flags) {
	return _Utils_Tuple2(
		{},
		elm$core$Platform$Cmd$none);
};
var author$project$Router$Book = function (a) {
	return {$: 'Book', a: a};
};
var author$project$Router$BookList = {$: 'BookList'};
var author$project$Router$BookNew = {$: 'BookNew'};
	...
	var parser = elm$url$Url$Parser$oneOf(
		_List_fromArray(
			[
				...
				author$project$Router$BookList,
				elm$url$Url$Parser$s('books')),
				A2(
				elm$url$Url$Parser$map,
				author$project$Router$Book,
				A2(
...
var author$project$Main$loadPage = F2(
	function (url, model) {
		var _n0 = author$project$Router$parseUrl(url);
		switch (_n0.$) {
			case 'NotFound':
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'Home':
				return A2(
					author$project$Main$loadPageHome,
					model,
					author$project$Page$Home$init(model.flags));
			case 'BookList':
				return A2(
					author$project$Main$loadBookListPage,
					model,
					author$project$Page$Book$List$init(model.flags));
			case 'Book':
				var id = _n0.a;
				return A2(
					author$project$Main$loadBookDetailPage,
					model,
					A2(author$project$Page$Book$Detail$init, model.flags, id));
			default:
				return A2(
					author$project$Main$loadBookAddPage,
					model,
					author$project$Page$Book$Add$init(model.flags));
		}
	});
var author$project$Main$init = F3(
	function (flags, url, key) {
		return A2(
			author$project$Main$loadPage,
			url,
			{flags: flags, key: key, page: author$project$Main$PageNotFound});
	});
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$Page$Book$Add$subscriptions = function (model) {
	return elm$core$Platform$Sub$none;
};
var author$project$Page$Book$Detail$subscriptions = function (model) {
	return elm$core$Platform$Sub$none;
};
var author$project$Page$Book$List$subscriptions = function (model) {
	return elm$core$Platform$Sub$none;
};
...
var author$project$Main$subscriptions = function (model) {
	...
	switch (_n0.$) {
		...
		case 'PageBookList':
			...
			return A2(
				elm$core$Platform$Sub$map,
				author$project$Main$BookListMsg,
				author$project$Page$Book$List$subscriptions(m));
		case 'PageBookDetail':
			var m = _n0.a;
			return A2(
				elm$core$Platform$Sub$map,
				author$project$Main$BookDetailMsg,
				author$project$Page$Book$Detail$subscriptions(m));
		default:
			var m = _n0.a;
			return A2(
				elm$core$Platform$Sub$map,
				author$project$Main$BookAddMsg,
				author$project$Page$Book$Add$subscriptions(m));
	}
};
var author$project$Page$Book$Add$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
	});
var author$project$Shared$Failure = {$: 'Failure'};
var author$project$Shared$Loaded = function (a) {
	return {$: 'Loaded', a: a};
};
var author$project$Page$Book$Detail$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Ok') {
			var book = msg.a.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						book: author$project$Shared$Loaded(book)
					}),
				elm$core$Platform$Cmd$none);
		} else {
			var err = msg.a.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{book: author$project$Shared$Failure}),
				elm$core$Platform$Cmd$none);
		}
	});
var author$project$Page$Book$List$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Ok') {
			var books = msg.a.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						books: author$project$Shared$Loaded(books)
					}),
				elm$core$Platform$Cmd$none);
		} else {
			var err = msg.a.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{books: author$project$Shared$Failure}),
				elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$update = F2(
	function (message, model) {
		switch (message.$) {
			...
			case 'OnUrlChange':
				var url = message.a;
				return A2(author$project$Main$loadPage, url, model);
			case 'HomeMsg':
				var msg = message.a;
				var _n2 = model.page;
				if (_n2.$ === 'PageHome') {
			...
			case 'BookListMsg':
				...
				if (_n3.$ === 'PageBookList') {
					...
					return A2(
						author$project$Main$loadBookListPage,
						model,
						A2(author$project$Page$Book$List$update, msg, bookList));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'BookDetailMsg':
				var msg = message.a;
				var _n4 = model.page;
				if (_n4.$ === 'PageBookDetail') {
					var book = _n4.a;
					return A2(
						author$project$Main$loadBookDetailPage,
						model,
						A2(author$project$Page$Book$Detail$update, msg, book));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			default:
				...
				if (_n5.$ === 'PageBookAdd') {
					...
					return A2(
						author$project$Main$loadBookAddPage,
						model,
						A2(author$project$Page$Book$Add$update, msg, m));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
		}
...
var author$project$Main$viewNavItem = function (_n0) {
	var label = _n0.a;
	var url = _n0.b;
	return A2(
		elm$html$Html$li,
...
var author$project$Router$pathFor = function (route) {
	switch (route.$) {
		case 'NotFound':
			return '/404';
		case 'Home':
		...
		case 'Book':
			var id = route.a;
			return '/books/' + elm$core$String$fromInt(id);
		default:
			return '/books/new';
	}
};
...
var author$project$Main$viewNav = function (model) {
	var routeList = _List_fromArray(
		[
			_Utils_Tuple2(
			'Home',
			author$project$Router$pathFor(author$project$Router$Home)),
			_Utils_Tuple2(
			'Books',
			author$project$Router$pathFor(author$project$Router$BookList))
		]);
	return A2(
		elm$html$Html$nav,
		_List_Nil,
		_List_fromArray(
			[
				...
				elm$html$Html$ul,
				_List_Nil,
				A2(elm$core$List$map, author$project$Main$viewNavItem, routeList))
			]));
};
var elm$html$Html$form = _VirtualDom_node('form');
var elm$html$Html$h1 = _VirtualDom_node('h1');
var author$project$Page$Book$Add$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Page$Book$Detail$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Page$Book$List$viewListItem = function (book) {
	var url = author$project$Router$pathFor(
		author$project$Router$Book(book.id));
	return A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
...
var author$project$Page$Book$List$viewList = function (books) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		A2(elm$core$List$map, author$project$Page$Book$List$viewListItem, books));
};
var author$project$Page$Book$List$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Router$pathFor(author$project$Router$BookNew))
							]),
						_List_fromArray(
							[
								elm$html$Html$text('add new one')
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						switch (_n0.$) {
							...
							case 'Loaded':
								var books = _n0.a;
								return author$project$Page$Book$List$viewList(books);
							default:
								return A2(
									elm$html$Html$div,
									_List_Nil,
		...
		switch (_n0.$) {
			...
			case 'PageBookList':
				...
				return A2(
					elm$html$Html$map,
					author$project$Main$BookListMsg,
					author$project$Page$Book$List$view(m));
			case 'PageBookDetail':
				var m = _n0.a;
				return A2(
					elm$html$Html$map,
					author$project$Main$BookDetailMsg,
					author$project$Page$Book$Detail$view(m));
			default:
				var m = _n0.a;
				return A2(
					elm$html$Html$map,
					author$project$Main$BookAddMsg,
					author$project$Page$Book$Add$view(m));
		}
	}();
	return A2(
		elm$html$Html$div,
...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'api', elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Model.Book":{"args":[],"type":"{ id : Basics.Int, description : String.String, isbn : String.String, title : String.String, publishedAt : Maybe.Maybe Date.Date }"},"Date.RataDie":{"args":[],"type":"Basics.Int"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"OnUrlRequest":["Browser.UrlRequest"],"OnUrlChange":["Url.Url"],"HomeMsg":["Page.Home.Msg"],"BookListMsg":["Page.Book.List.Msg"],"BookDetailMsg":["Page.Book.Detail.Msg"],"BookAddMsg":["Page.Book.Add.Msg"]}},"Page.Book.Add.Msg":{"args":[],"tags":{"NoOp":[]}},"Page.Book.Detail.Msg":{"args":[],"tags":{"OnFetch":["Result.Result Http.Error Model.Book"]}},"Page.Book.List.Msg":{"args":[],"tags":{"OnFetchBooks":["Result.Result Http.Error (List.List Model.Book)"]}},"Page.Home.Msg":{"args":[],"tags":{"NoOp":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Date.Date":{"args":[],"tags":{"RD":["Date.RataDie"]}}}}})}});}(this));