...
var author$project$Main$PageNone = {$: 'PageNone'};
...
var author$project$Book$Book = F5(
...
var author$project$Book$decode = A6(
...
var author$project$Pages$BookList$OnFetchBooks = function (a) {
...
var author$project$Pages$BookList$fetchBooks = function (flags) {
	return elm$http$Http$get(
		{
			expect: A2(
				elm$http$Http$expectJson,
				author$project$Pages$BookList$OnFetchBooks,
				elm$json$Json$Decode$list(author$project$Book$decode)),
			url: flags.api + '/books.json'
		});
};
var author$project$Shared$Loading = {$: 'Loading'};
var author$project$Pages$BookList$init = function (flags) {
	return _Utils_Tuple2(
		{books: author$project$Shared$Loading},
		author$project$Pages$BookList$fetchBooks(flags));
};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Pages$Home$init = function (flags) {
	return _Utils_Tuple2(
		{},
...
var author$project$Main$loadPage = function (_n0) {
	...
	var _n1 = function () {
		...
		switch (_n2.$) {
			case 'HomeRoute':
				var _n3 = author$project$Pages$Home$init(model.flags);
				var pageModel = _n3.a;
				var pageCmd = _n3.b;
				return _Utils_Tuple2(
					author$project$Main$PageHome(pageModel),
			...
			default:
				var _n4 = author$project$Pages$BookList$init(model.flags);
				var pageModel = _n4.a;
				var pageCmd = _n4.b;
				return _Utils_Tuple2(
					author$project$Main$PageBookList(pageModel),
					A2(elm$core$Platform$Cmd$map, author$project$Main$BookListMsg, pageCmd));
		}
	}();
	var page = _n1.a;
	var newCmd = _n1.b;
...
var author$project$Routes$NotFoundRoute = {$: 'NotFoundRoute'};
var author$project$Routes$BookListRoute = {$: 'BookListRoute'};
var author$project$Routes$HomeRoute = {$: 'HomeRoute'};
...
var author$project$Routes$matchRoute = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			author$project$Routes$BookListRoute,
...
var author$project$Routes$parseUrl = function (url) {
	var _n0 = A2(elm$url$Url$Parser$parse, author$project$Routes$matchRoute, url);
	if (_n0.$ === 'Just') {
		var route = _n0.a;
		return route;
	} else {
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		var model = {
			flags: flags,
			navKey: key,
			page: author$project$Main$PageNone,
...
var author$project$Pages$BookList$subscriptions = function (model) {
	...
	switch (_n0.$) {
		...
		case 'PageHome':
			...
			return A2(
				...
				author$project$Pages$Home$subscriptions(pageModel));
		default:
			var pageModel = _n0.a;
			return A2(
				elm$core$Platform$Sub$map,
				author$project$Main$BookListMsg,
				author$project$Pages$BookList$subscriptions(pageModel));
	}
};
...
var author$project$Pages$BookList$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Ok') {
			var books = msg.a.a;
			return _Utils_Tuple2(
			...
			switch (_n0.a.$) {
				...
				case 'HomeMsg':
					if (_n0.b.$ === 'PageHome') {
						...
						var _n2 = A2(author$project$Pages$Home$update, subMsg, pageModel);
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: author$project$Main$PageHome(newPageModel)
								}),
				...
				default:
					if (_n0.b.$ === 'PageBookList') {
						var subMsg = _n0.a.a;
						var pageModel = _n0.b.a;
						var _n3 = A2(author$project$Pages$BookList$update, subMsg, pageModel);
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: author$project$Main$PageBookList(newPageModel)
								}),
							A2(elm$core$Platform$Cmd$map, author$project$Main$BookListMsg, newCmd));
					} else {
						break _n0$4;
					}
			}
...
var author$project$Routes$routes = _List_fromArray(
	[
		_Utils_Tuple2(
		'Home',
		author$project$Routes$pathFor(author$project$Routes$HomeRoute)),
		_Utils_Tuple2(
		'Books',
		author$project$Routes$pathFor(author$project$Routes$BookListRoute))
	]);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$ul,
				_List_Nil,
				A2(elm$core$List$map, author$project$Main$viewNavItem, author$project$Routes$routes))
			]));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								if (_n0.$ === 'Just') {
									var isbn = _n0.a;
									return elm$html$Html$text(isbn);
								} else {
									return elm$html$Html$text('');
								}
							}()
...
var author$project$Pages$BookList$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
		...
		switch (_n0.$) {
			case 'PageHome':
				...
				return A2(
					elm$html$Html$map,
					author$project$Main$HomeMsg,
					author$project$Pages$Home$view(pageModel));
			case 'PageBookList':
				var pageModel = _n0.a;
				return A2(
					elm$html$Html$map,
					author$project$Main$BookListMsg,
					author$project$Pages$BookList$view(pageModel));
			default:
...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'api', elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Book.Book":{"args":[],"type":"{ id : Basics.Int, description : Maybe.Maybe String.String, isbn : Maybe.Maybe String.String, title : String.String, publishedAt : Maybe.Maybe Date.Date }"},"Date.RataDie":{"args":[],"type":"Basics.Int"}},"unions":{"Main.Msg":{"args":[],"tags":{"OnUrlRequest":["Browser.UrlRequest"],"OnUrlChange":["Url.Url"],"BookListMsg":["Pages.BookList.Msg"],"HomeMsg":["Pages.Home.Msg"]}},"Pages.BookList.Msg":{"args":[],"tags":{"OnFetchBooks":["Result.Result Http.Error (List.List Book.Book)"]}},"Pages.Home.Msg":{"args":[],"tags":{"NoOp":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Date.Date":{"args":[],"tags":{"RD":["Date.RataDie"]}}}}})}});}(this));